\section{Phân phối Gamma (Gamma Distribution)}
	...
	\begin{figure}[h!]
		\centering
		\includegraphics[width=0.7\textwidth]{images/Gamma Distribution-PDF.png} % Placeholder cho hình ảnh
	...
	Dưới đây, là biểu đồ minh họa hàm phân phối tích lũy của phan phối Gamma
		...
		\begin{figure}[h!]
		\centering
		\includegraphics[width=0.7\textwidth]{images/Gamma Distribution-CDF.png} % Placeholder cho hình ảnh
		\caption{Hàm mật độ xác suất của Phân phối Gamma với các tham số khác nhau.}
