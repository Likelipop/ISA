...
Thời gian chạy mê cung của chúng là $8, 10, 15$ giây, và thời gian của hai con chuột đối chứng là $5, 9$ giây.
    ...
    \item Tính chênh lệch thời gian trung bình giữa nhóm điều trị và nhóm đối chứng.
    \item Viết ra tất cả các hoán vị có thể có của những thời gian này cho hai nhóm và tính chênh lệch
về giá trị trung bình.
    \item Tỷ lệ chênh lệch nào lớn hơn hoặc bằng chênh lệch thời gian trung bình quan sát được?
    \item Với mỗi hoán vị, hãy chỉ tính giá trị trung bình của nhóm điều trị. Tỷ lệ nào trong số các giá
trị trung bình này lớn hơn hoặc bằng chênh lệch thời gian trung bình quan sát được của nhóm
điều trị?
    \end{enumerate}

%-----------------a)---------------------
   \begin{subquestion}{Tính chênh lệch thời gian trung bình giữa nhóm điều trị và nhóm đối chứng.}
    \begin{answer}
    ...
    Chênh lệch trung bình quan sát được: \\
        \begin{align*}
        \bar{d}_{obs} &= \bar{T} - \bar{C} \\
                      &= 11 - 7 \\
                      &= 4 \quad \text{(giây)}
        \end{align*}

    Vậy chênh lệch thời gian trung bình giữa nhóm điều trị và nhóm đối chứng:
    $\bar{d}_{obs} = \mathbf{4}$ (giây)
    \end{answer}
    \end{subquestion}

%-----------------b)---------------------
    \begin{subquestion}{Viết ra tất cả các hoán vị có thể có của những thời gian này cho hai nhóm và tính chênh lệch
về giá trị trung bình.}
    \newpage
    \begin{answer}
    Tổng số quan sát là $N= n_T + n_C = 3 + 2 = 5$. Số cách chia thành hai nhóm $n_T=3$ và $n_C=2$ là (hoán vị): \\
    $$K = \binom{5}{3} = \frac{5!}{3!2!} = \mathbf{10}$$ 
...
%-----------------c)---------------------
    \begin{subquestion}{Tỷ lệ chênh lệch nào lớn hơn hoặc bằng chênh lệch thời gian trung bình quan sát được?.}
    \begin{answer}
    ...
    Từ bảng trên, các hoán vị có $\bar{d}_{obs} \ge 4$:
        ...
        \begin{itemize}
            \item Thứ tự 9: $4.00$ (giây)
            \item Thứ tự 10: $5.33$ (giây)
        \end{itemize}
...
% -----------------d)--------------------------------------
    ...
    \begin{subquestion}{Với mỗi hoán vị, hãy chỉ tính giá trị trung bình của nhóm điều trị. Tỷ lệ nào trong số các giá
trị trung bình này lớn hơn hoặc bằng chênh lệch thời gian trung bình quan sát được của nhóm
điều trị?.}
    \begin{answer}
    ...
    Từ bảng (cột $\bar{y}_T$), các giá trị $\ge 11$ là:
        ...
        \begin{itemize}
            \item Thứ tự 9: $11.00$ (giây)
            \item Thứ tự 10: $11.33$ (giây)
        \end{itemize}
