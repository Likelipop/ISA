...
\paragraph{Ứng dụng 1: Phân phối chuẩn trong điểm thi THPT Quốc gia.}   
...
\begin{itemize}
    ...
    \item \textbf{Lệch phải rõ rệt}: phần lớn dữ liệu tập trung ở gần số 0, và tần suất giảm dần theo hàm mũ khi giá trị tăng lên, tạo thành một cái "đuôi" dài về phía dương.
    \item \textbf{Không đối xứng}: chỉ có một đuôi phải, giảm theo $e^{-\lambda x}$.
    \item \textbf{Tính không nhớ (memoryless)}: $P(X > s + t \mid X > s) = P(X > t)$, đặc trưng riêng của phân phối mũ.
\end{itemize}
